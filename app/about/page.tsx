      ...
      <div className="lg:grid lg:grid-cols-2 lg:gap-20">
        <section>
          ...
          <div className="mt-3 mb-4 space-y-3 font-noto text-muted-foreground">
            ...
            <p>
              I enjoy turning ideas into real products, paying close attention
              to the details that shape how users interact with an interface.
              For me, it’s not just about making things work, but making them
              feel right.
            </p>
            <p>
              I primarily work with React and Next.js, and I’m intentional about
              writing clean, maintainable code that can scale as a project
              grows. I’m constantly improving how I structure applications and
              approach problem-solving, with the goal of building products that
              are both practical and polished.
            </p>
          </div>
